...
function copy_all_names_for_discord_eh(event) {
    vscode.postMessage({ command: "copy_all_names_for_discord", text: "" });
}
...
(function () {
    ...
    const copy_discord_button = document.querySelector(".copy-all-key-names-for-discord-button");

    copy_discord_button.addEventListener("click", copy_all_names_for_discord_eh);
