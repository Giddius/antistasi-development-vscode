...
class Snippet:
    ...
    def __init__(self,
        ...
        self.name: str = name
        self.text: str = text
        self.language: str = languague
        self.prefix: str = prefix or self._prefix_from_name(self.name)
    ...
    @classmethod
    def _prefix_from_name(cls, name: str) -> str:
        ...

    def to_json(self) -> str:
        data = {self.name: {"prefix": self.prefix,
                            "description": self.description,
                            "body": self.text_lines}}
        return json.dumps(data, default=str, indent=4)


def create_file_name(language_name: str) -> str:
    ...
